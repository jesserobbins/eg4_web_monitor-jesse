...
PARAM_FUNC_BATTERY_ECO_EN = "FUNC_BATTERY_ECO_EN"  # Register 110, bit 9
...
# AC couple parameter names (registers 220-223)
...
# AC couple Modbus register addresses (for raw read/write)
REG_AC_COUPLE_START_SOC = 220
REG_AC_COUPLE_END_SOC = 221
REG_AC_COUPLE_START_VOLT = 222
REG_AC_COUPLE_END_VOLT = 223
