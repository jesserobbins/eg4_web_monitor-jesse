...
_WORKING_MODE_PARAMETERS: dict[str, str | None] = {
    ...
    "FUNC_BATTERY_ECO_EN": PARAM_FUNC_BATTERY_ECO_EN,  # Register 110, bit 9
}
...
class EG4WorkingModeSwitch(EG4BaseSwitch):
    ...
    async def _execute_working_mode(self, turn_on: bool) -> None:
        ...
        # FUNC_179_BIT11: AC coupling on 12000XP, register 179 bit 11.
        # Use raw register write to bypass pylxpweb mapping.
        if param == "FUNC_179_BIT11":
